...
class Appusers extends REST_Controller
{
    ...
    function addnew_post()
	{
        ...
        //if($data['profile_photo'])
				...
				if (preg_match("/^([421570|462436|485447|469345|622100]{6})([0-9]{10})$/", $data['id_card'], $match)){
