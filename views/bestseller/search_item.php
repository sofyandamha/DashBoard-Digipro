			...
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo site_url('bestseller');?>"><?php echo $this->lang->line('item_list_label')?></a> <span class="divider"></span></li>
				...
				<div class='col-sm-10'>
                    ...
                    <div class="form-group" style="display: none;">
                        ...
                        <?php echo form_input(array(
					  	...
					  	<a href='<?php echo site_url('bestseller');?>' class="btn btn-default"><?php echo $this->lang->line('reset_button')?></a>
					</form>
				</div>	
				<!--<div class='col-sm-2'>
			...
			$(document).ready(function(){
					...
					$.ajax({
						...
						success:function(msg){
							if(msg == 'true')
								...
								alert('publish error occured.'+msg);
						}
					});
				});
				...
				$(document).delegate('.show','click',function(){
					...
					$.ajax({
						url: '<?php echo site_url('bestseller/showOnHome');?>/'+id,
						method:'GET',
						success:function(msg){
							if(msg == 'true')
				...
				$(document).delegate('.no-show','click',function(){
					...
					$.ajax({
						url: '<?php echo site_url('bestseller/hideOnHome');?>/'+id,
						method:'GET',
						success:function(msg){
							if(msg == 'true')
