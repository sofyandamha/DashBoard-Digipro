			          ...
			          <div class="card">
			            ...
			            <div class="card-body">
			            	...
			            	<div class="row">
								...
								echo form_open(site_url('reports/searchreport'),$attributes);
							?>
							...
							<?php echo form_close(); ?>
			            		...
			            		<div class="col-sm-3">
			            			...
			            			<a href="<?php echo site_url('reports/dompdf') ?>"><button type="button" class="btn btn-primary float-right" style="margin-right: 5px;">
