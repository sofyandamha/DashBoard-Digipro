...
?>
	<div class="row">
		...
		<ul id="myTab" class="nav nav-tabs">
			...
			<li><a href="#sender" data-toggle="tab">Socmed & Sending Email Setting(For SMTP)</a></li>
		</ul>
		...
		<div id="myTabContent" class="tab-content">
			<div class="tab-pane fade in active" id="shopinfo">
				...
				<div class="row">
					...
					<div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label><?php echo $this->lang->line('privacy_label')?>
                                <a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo $this->lang->line('privacy_tooltips')?>">
									<span class='glyphicon glyphicon-info-sign menu-icon'>
                                </a>
                            </label>
                            <textarea class="form-control" name="privacy" placeholder="Privacy & Policy" rows="9"><?php echo $shop->privacy;?></textarea>
                        </div>

						<div class="form-group">
							<label><?php echo $this->lang->line('tos_label')?>
								<a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo $this->lang->line('tos_tooltips')?>">
									<span class='glyphicon glyphicon-info-sign menu-icon'>
								</a>
							</label>
							<textarea class="form-control" name="tos" placeholder="TOS" rows="9"><?php echo $shop->tos;?></textarea>
						</div>



                        <div class="form-group">
                            <label><?php echo $this->lang->line('faq_label')?>
                                <a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo $this->lang->line('faq_tooltips')?>">
									<span class='glyphicon glyphicon-info-sign menu-icon'>
                                </a>
                            </label>
                            <textarea class="form-control" name="faq" placeholder="FAQ" rows="9"><?php echo $shop->faq;?></textarea>
                        </div>
			...
			<div class="tab-pane fade" id="sender">
				...
				<div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label><?php echo $this->lang->line('facebook_label')?>
                            <a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo $this->lang->line('facebook_tooltips')?>">
								<span class='glyphicon glyphicon-info-sign menu-icon'>
                            </a>
                        </label>

                        <input class="form-control" type="text" placeholder="Facebook Account" name='facebook' id='facebook' value="<?php echo $shop->facebook;?>">
                    </div>
                    <div class="form-group">
                        <label><?php echo $this->lang->line('twitter_label')?>
                            <a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo $this->lang->line('twitter_tooltips')?>">
								<span class='glyphicon glyphicon-info-sign menu-icon'>
                            </a>
                        </label>

                        <input class="form-control" type="text" placeholder="Twitter Account" name='twitter' id='twitter' value="<?php echo $shop->twitter;?>">
                    </div>
                    <div class="form-group">
                        <label><?php echo $this->lang->line('instagram_label')?>
                            <a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo $this->lang->line('instagram_tooltips')?>">
								<span class='glyphicon glyphicon-info-sign menu-icon'>
                            </a>
                        </label>

                        <input class="form-control" type="text" placeholder="Instagram Account" name='instagram' id='instagram' value="<?php echo $shop->instagram;?>">
                    </div>
				</div>
