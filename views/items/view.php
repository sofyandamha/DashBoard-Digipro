								...
								?>
										<tr>
											...
											<?php 
												if(!$this->session->userdata('is_shop_admin')) { 
													if(in_array('delete',$allowed_accesses)):?>
														<td><a class='btn-delete' data-toggle="modal" data-target="#myModal" id="<?php echo $item->id; ?>"><i class='fa fa-trash'></i></a></td>
											<?php endif; } else { ?>
														<td><a class='btn-delete' data-toggle="modal" data-target="#myModal" id="<?php echo $item->id; ?>"><i class='fa fa-trash'></i></a></td>
											<?php } ?>	
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>you want to delete?&hellip;</p>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default btn-no" data-dismiss="modal">Cancel</button>
              <a type="button" class="btn btn-primary btn-yes" href='<?php echo site_url("items/delete/");?>'>Delete</a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
