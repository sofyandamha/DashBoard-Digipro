			        ...
			        <div class="row mb-2">
			          ...
			          <div class="col-sm-6">
			            ...
			            <ol class="breadcrumb float-sm-right">
							...
							<li class="breadcrumb-item active">Poin List</li>
			            </ol>
			          </div>
			        </div>
			      </div><!-- /.container-fluid -->
			          ...
			          <div class="card">
			            ...
			            <div class="card-body">
							<?php
								...
								echo form_open(site_url('poin/search'),$attributes);
							?>
							...
							<table id="example2" class="table table-striped table-bordered">
								...
								?>
										<tr>
				                            ...
				                            <td><?php echo $appuser->Count_poin;?></td>
...
$(document).ready(function(){
	$(document).delegate('.ban','click',function(){
		...
		$.ajax({
			url: '<?php echo site_url('poin/ban');?>/'+id,
			method:'GET',
	...
	$(document).delegate('.unban','click',function(){
		...
		var id = $(this).attr('appuserid');
		$.ajax({
			url: '<?php echo site_url('poin/unban');?>/'+id,
			method:'GET',
			success:function(msg){
				if(msg == 'true')
