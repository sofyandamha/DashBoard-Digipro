			        ...
			        <div class="row mb-2">
			          ...
			          <div class="col-sm-6">
			            ...
			            <ol class="breadcrumb float-sm-right">
							...
							<li class="breadcrumb-item active"><?php echo $this->lang->line('users_list_label')?></li>
			            </ol>
			          </div>
			        </div>
			      </div><!-- /.container-fluid -->
			      ...
			      <div class="row">
					...
					?>
							<tr>
								...
								<?php if(in_array('edit',$allowed_accesses)):?>
									<td><a href='<?php echo site_url("users/edit/".$user->user_id);?>'><i class='fas fa-edit'></i></a></td>
								<?php endif;?>
