							...
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group">
										...
										<input class="form-control" type="password" placeholder="current password" name='oldpass' id='oldpass'>
									</div>
									
									<div class="form-group">
										<label><?php echo $this->lang->line('password_label')?></label>
										<input class="form-control" type="password" placeholder="new password" name='user_password' id='user_password'>
									</div>
