...
$config['sender_email']	= 'btndigipro@gmail.com';
$config['sender_name'] = 'btndigipro@gmail.com';
$config['sender_password'] = 'gyevogoirlblwizi';

$config['composer_autoload'] = "./vendor/autoload.php";

$config['smtp_crypto']  ='tls';
$config['stripe_secret_key'] = "sk_test_40CJCNOtnGBBHSozexk4jTsR";
$config['fcm_api_key']  = "AIzaSyAKKPvvBNwE1sBptbZOjxgWSffv_H7bgyo";
...
|
*/
$config['uri_protocol']	='REQUEST_URI';//'DOCUMENT_URI';//'AUTO';
