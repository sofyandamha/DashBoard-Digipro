...
$config['cachedir'] 	= 'application/cache/'; //string, the default is tmp/cache/
$config['imagedir'] 	= 'uploads/qr_codes/'; //string, the default is tmp/qr_codes/
$config['errorlog'] 	= 'application/logs/'; //string, the default is tmp/logs/
