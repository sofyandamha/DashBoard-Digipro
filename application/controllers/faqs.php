...
class Faqs extends Main
{
	...
	function index()
	{
		...
		$pag['total_rows'] = $this->faq->count_all($this->get_current_shop()->id);
		$data['reviews'] = $this->faq->get_all($this->get_current_shop()->id, $pag['per_page'], $this->uri->segment(3));
		$data['pag'] = $pag;
