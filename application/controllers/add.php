			...
			?>
				...
				<div class="row">
					<div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label><?php echo $this->lang->line('item_stock_label')?>
                                <a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo $this->lang->line('item_stock_tooltips')?>">
										<span class='glyphicon glyphicon-info-sign menu-icon'>
                                </a>
                            </label>
                            ...
                            <?php echo form_input(array(
                                ...
                                'value' => '',
                                'class' => 'form-control',
                                'placeholder' => $this->lang->line('item_stock_label'),
                                'id' => ''
                            )); ?>
