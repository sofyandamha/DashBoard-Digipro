            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item "><a href="<?php echo site_url('items'); ?>">list</a></li>
                        <li class="breadcrumb-item "><a href="<?php echo site_url("items/edit/" . $id); ?>">edit</a> <span class="divider"></span></li>
...
<script id="template-upload" type="text/x-tmpl">
    ...
    <tr class="template-upload">
        ...
        <td class="title">
                ...
                <input type="" name="type" value="<?php echo $_SESSION['type']; ?>"/>
                <label>Desc:</label>
...
<script id="template-download" type="text/x-tmpl">
    ...
    <tr class="template-download">
        <td>
                {% if (file.url) { %}
                    <a href="{%=file.url%}" title="{%=file.name%}" download="{%=file.name%}" data-gallery><img src="{%=file.url%}" width="100%"></a>
                {% } %}
    ...
    <tr class="template-download">
        <td class="title">
                ...
                <input class="id"  name="id[]" value="{%=file.id%}"/>
                <input name="parent_id" value="<?php echo $_SESSION['parent_id']; ?>"/>
                <label>Desc:</label>
                <textarea class="form-control desc" name="description[]">{%=file.description%}</textarea>
                {% if (file.error) { %}
                
                    <div><p class="text-danger">Error</p> {%=file.error%}</div>
                {% } %}
